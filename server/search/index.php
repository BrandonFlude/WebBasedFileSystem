...
<body>
  ...
  <div class="container">
    <div class="row">
      <div class="col-12">
        <center><h1>Looking for <?php echo $searchCriteria ?>...</h1></center>
        <div class="card">
          <table class="table table-hover">
            ...
            <tbody>
              ...
              // Loop through files that meet the search criteria
              $data = $goSql->runQuery("select", "SELECT document_name, document_real_name, document_ext, file_description FROM docs WHERE (document_real_name LIKE '%$searchCriteria%' AND document_real_name != 'null') OR (file_description LIKE '%$searchCriteria%' AND document_real_name != 'null')");
              if($data != false) {
